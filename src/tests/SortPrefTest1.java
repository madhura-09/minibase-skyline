...
class SortPrefDriver extends TestDriver
    ...
    protected boolean test2()
    {
        ...
        SortPref sort = null;
        try {
            sort = new SortPref(attrType, (short) 1, attrSize, fscan, order[1],pref_list,pref_list_length, SORTPGNUM);
        }
    ...
    protected boolean test3()
    {
        ...
        SortPref sort = null;
        try {
            sort = new SortPref(attrType, (short) 4, attrSize, fscan, order[0],pref_list,pref_list_length, SORTPGNUM);
        }
    ...
    protected boolean test4()
    {
        ...
        SortPref sort2 =null;
        try {
            sort1 = new SortPref(attrType, (short) 2, attrSize, fscan1, order[0],pref_list,pref_list_length, SORTPGNUM);
            sort2 = new SortPref(attrType, (short) 2, attrSize, fscan2, order[1],pref_list,pref_list_length, SORTPGNUM);
        }
        // Sort input files
        catch (Exception e) {
            status = FAIL;
