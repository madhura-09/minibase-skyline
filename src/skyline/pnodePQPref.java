...
public abstract class pnodePQPref
{
    ...
    public int pnodeCMP(pnode a, pnode b)
        ...
        int ans = Methods.CompareTupleWithTuplePref(a.tuple, Attr_type,b.tuple, Attr_type, (short) 0,temp, pref_attr,pref_attr.length);
        return ans;
    }
